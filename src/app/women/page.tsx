...
// Get all women's products across collections
const getWomensProducts = (): ExtendedProductType[] => {
  const womensProducts: ExtendedProductType[] = [];
  
  Object.values(collectionsData).forEach(collection => {
    // Filter women's products - assuming we have a gender property or we're filtering based on collection
    // For now, let's include products from "celestial-occasions" as women's products
    ...
    const collectionProducts = collection.products.filter(product => 
      (product as ExtendedProductType).gender === 'women' || 
      (!(product as ExtendedProductType).gender && ['celestial-occasions'].includes(collection.id))
    );
...
export default function WomenPage() {
  ...
  useEffect(() => {
    // Get women's products on client side to avoid hydration issues
    setProducts(getWomensProducts());
  }, []);
    ...
    <div className="flex flex-col pt-[70px]">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            <motion.p variants={fadeIn} className="uppercase tracking-wider text-[#b49146] mb-4 text-sm">Timeless Sophistication</motion.p>
            <motion.h1 variants={fadeIn} className="text-5xl md:text-6xl luxury-heading mb-6">Women&apos;s Collection</motion.h1>
            ...
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-[#f2f2f2]/90 mb-8">
              Explore our elegant women&apos;s collections, crafted to perfection for those who appreciate the finest in luxury fashion.
              Each piece embodies grace, sophistication, and HANKAR&apos;s uncompromising commitment to quality.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <nav className="text-sm text-[#0a1118]/70">
            <ol className="flex flex-wrap items-center">
              ...
              <li className="text-[#b49146]">Women</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <section className="luxury-section bg-white">
        <div className="container-custom">
          ...
          >
            <motion.h2 variants={fadeIn} className="luxury-heading text-3xl text-[#0a1118] mb-4">Our Women&apos;s Collection</motion.h2>
            <motion.div variants={scaleUp} className="h-px w-24 bg-[#b49146] mx-auto mb-6"></motion.div>
            <motion.p variants={fadeIn} className="text-[#0a1118]/80 max-w-2xl mx-auto">
              From celestial occasions to everyday luxury, our women&apos;s collection captures the essence of timeless elegance with impeccable craftsmanship and exquisite materials.
            </motion.p>
          </motion.div>
        ...
        <div className="container-custom max-w-4xl">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-lg text-[#f2f2f2]/80 mb-12 max-w-3xl mx-auto">
              Experience our full women&apos;s collection in person at our Mumbai flagship. Our specialists are available for private consultations to help you discover the perfect HANKAR pieces for your wardrobe.
            </motion.p>
